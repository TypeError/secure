...
class TestHeaderConsistency(unittest.TestCase):
    def test_value_methods_reject_crlf(self):
    ...
    def test_clear_restores_default_values(self):
    ...
    def test_cache_control_canonical_order(self):
    ...
    def test_content_security_policy_values_deduplicate(self):
    ...
    def test_permissions_policy_wildcard_must_be_alone(self):
        policy = PermissionsPolicy().camera("*")
        with self.assertRaises(ValueError):
            policy.camera("*", "self")

    def test_referrer_policy_add_is_idempotent(self):
    ...
    def test_xdns_prefetch_control_normalizes_values(self):
    ...
    def test_x_permitted_policy_rejects_unknown(self):
        with self.assertRaises(ValueError):
